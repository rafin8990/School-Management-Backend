...
class TabulationFormat2Service {
  async getTabulationFormat2Report(filters: ITabulationFilters): Promise<ITabulationResponse> {
    try {
      ...
      console.error('Error in getTabulationFormat2Report:', error);
      throw error;
    }
  }
...
export const tabulationFormat2Service = new TabulationFormat2Service();
