    ...
    schemas: {
      ...
      Student: {
        ...
        properties: {
          ...
          student_id: { type: 'string', nullable: true, example: '2025001' },
          mobile: { type: 'string', nullable: true, example: '+8801700000000' },
          group_id: { type: 'integer', example: 1 },
          section_id: { type: 'integer', nullable: true, example: 1 },
          class_id: { type: 'integer', example: 1 },
          date_of_birth: { type: 'string', nullable: true, example: '2010-01-01' },
          roll: { type: 'integer', nullable: true, example: 1 },
          ...
          national_id: { type: 'string', nullable: true, example: '1234567890' },
          nationality: { type: 'string', nullable: true, example: 'Bangladeshi' },
          religion: { type: 'string', nullable: true, example: 'Islam' },
          session_id: { type: 'integer', nullable: true, example: 1 },
          academic_year_id: { type: 'integer', example: 1 },
          admission_date: { type: 'string', nullable: true, example: '2025-01-01' },
          student_photo: { type: 'string', nullable: true, example: 'https://example.com/photo.jpg' },
          father_name: { type: 'string', nullable: true, example: 'Father Name' },
          father_nid: { type: 'string', nullable: true, example: '1234567890' },
          father_mobile: { type: 'string', nullable: true, example: '+8801700000001' },
          father_dob: { type: 'string', nullable: true, example: '1980-01-01' },
          father_occupation: { type: 'string', nullable: true, example: 'Engineer' },
          father_income: { type: 'number', nullable: true, example: 50000 },
          mother_name: { type: 'string', nullable: true, example: 'Mother Name' },
          mother_nid: { type: 'string', nullable: true, example: '1234567891' },
          mother_mobile: { type: 'string', nullable: true, example: '+8801700000002' },
          mother_dob: { type: 'string', nullable: true, example: '1985-01-01' },
          mother_occupation: { type: 'string', nullable: true, example: 'Teacher' },
          mother_income: { type: 'number', nullable: true, example: 30000 },
          current_village: { type: 'string', nullable: true, example: 'Village Name' },
          current_post_office: { type: 'string', nullable: true, example: 'Post Office' },
          current_post_code: { type: 'string', nullable: true, example: '1230' },
          current_district: { type: 'string', nullable: true, example: 'Dhaka' },
          current_thana: { type: 'string', nullable: true, example: 'Tejgaon' },
          permanent_village: { type: 'string', nullable: true, example: 'Village Name' },
          permanent_post_office: { type: 'string', nullable: true, example: 'Post Office' },
          permanent_post_code: { type: 'string', nullable: true, example: '1230' },
          permanent_district: { type: 'string', nullable: true, example: 'Dhaka' },
          permanent_thana: { type: 'string', nullable: true, example: 'Tejgaon' },
          guardian_name: { type: 'string', nullable: true, example: 'Guardian Name' },
          guardian_address: { type: 'string', nullable: true, example: 'Guardian Address' },
          last_institution: { type: 'string', nullable: true, example: 'Previous School' },
          last_class: { type: 'string', nullable: true, example: 'Class 5' },
          registration_number: { type: 'string', nullable: true, example: 'REG123456' },
          result: { type: 'string', nullable: true, example: 'A+' },
          year_passed: { type: 'string', nullable: true, example: '2024' },
          status: { type: 'string', enum: ['active', 'inactive'], example: 'active' },
          password: { type: 'string', nullable: true, example: '123456' },
          school_id: { type: 'integer', example: 1 },
          class_name: { type: 'string', nullable: true, example: 'Class 6' },
          group_name: { type: 'string', nullable: true, example: 'Science' },
          section_name: { type: 'string', nullable: true, example: 'A' },
          category_name: { type: 'string', nullable: true, example: 'General' },
          academic_year_name: { type: 'string', nullable: true, example: '2024-25' },
          session_name: { type: 'string', nullable: true, example: 'Morning' },
          created_at: { type: 'string', format: 'date-time' },
          updated_at: { type: 'string', format: 'date-time' },
        },
      },
      CreateStudentRequest: {
        type: 'object',
        required: ['student_name', 'group_id', 'class_id', 'academic_year_id', 'school_id'],
        properties: {
          student_name: { type: 'string', example: 'John Doe' },
          student_id: { type: 'string', nullable: true, example: '2025001' },
          mobile: { type: 'string', nullable: true, example: '+8801700000000' },
      ...
      GenerateStudentIdResponse: {
        type: 'object',
        properties: {
          success: { type: 'boolean', example: true },
          message: { type: 'string', example: 'Student ID generated successfully' },
          data: { type: 'string', example: '2025001' },
        },
      },
      ClassWithAssignments: {
        ...
        properties: {
          ...
          shift_name: { type: 'string', nullable: true, example: 'Morning' },
        },
      },
      ClassesWithAssignmentsResponse: {
        type: 'object',
        properties: {
          success: { type: 'boolean', example: true },
          message: { type: 'string', example: 'Classes with assignments retrieved successfully' },
          data: {
            type: 'array',
            items: { $ref: '#/components/schemas/ClassWithAssignments' },
          },
        },
      },
    },
    ...
    '/basic-setting/class-exams/{id}': {
      ...
      '/students': {
        get: {
          ...
          parameters: [
            { in: 'query', name: 'searchTerm', schema: { type: 'string' }, description: 'Search term for student name, ID, or mobile' },
            { in: 'query', name: 'student_name', schema: { type: 'string' }, description: 'Filter by student name' },
            { in: 'query', name: 'student_id', schema: { type: 'string' }, description: 'Filter by student ID' },
            { in: 'query', name: 'mobile', schema: { type: 'string' }, description: 'Filter by mobile number' },
            { in: 'query', name: 'class_id', schema: { type: 'integer' }, description: 'Filter by class ID' },
            { in: 'query', name: 'group_id', schema: { type: 'integer' }, description: 'Filter by group ID' },
            { in: 'query', name: 'section_id', schema: { type: 'integer' }, description: 'Filter by section ID' },
            { in: 'query', name: 'academic_year_id', schema: { type: 'integer' }, description: 'Filter by academic year ID' },
            { in: 'query', name: 'status', schema: { type: 'string', enum: ['active', 'inactive'] }, description: 'Filter by status' },
            { in: 'query', name: 'school_id', schema: { type: 'integer' }, description: 'Filter by school ID' },
          ...
          responses: {
            200: {
              ...
              content: { 'application/json': { schema: { $ref: '#/components/schemas/PaginatedStudentResponse' } } },
            },
          },
        },
        post: {
          ...
          responses: {
            201: {
              ...
              content: { 'application/json': { schema: { $ref: '#/components/schemas/SingleStudentResponse' } } },
            },
          },
        },
      },
      '/students/generate-student-id': {
        get: {
          tags: ['Student'],
          summary: 'Generate next student ID for a school',
          parameters: [
            { in: 'query', name: 'school_id', required: true, schema: { type: 'integer' }, description: 'School ID' },
          ],
          responses: {
            200: {
              description: 'Student ID generated successfully',
              content: { 'application/json': { schema: { $ref: '#/components/schemas/GenerateStudentIdResponse' } } },
            },
          },
        },
      },
      '/students/classes-with-assignments': {
        get: {
          tags: ['Student'],
          summary: 'Get classes with their assigned groups, sections, and shifts',
          parameters: [
            { in: 'query', name: 'school_id', required: true, schema: { type: 'integer' }, description: 'School ID' },
          ],
          responses: {
            200: {
              ...
              content: { 'application/json': { schema: { $ref: '#/components/schemas/ClassesWithAssignmentsResponse' } } },
            },
          },
        },
      },
      '/students/{id}': {
        get: {
          ...
          parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'integer' }, description: 'Student ID' }],
          responses: {
            200: {
